...
The bundled JSON files under `presets/` and the T-POSE/A-POSE files under `rest_pose_presets/` are copies of BlendCap's shipped data and remain GPL-3.0-covered material.
